...
public class Product4 { 
	...
	public Product4(WebDriver driver) { 
		this.driver = driver;  
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//*[@id=\"item_5_img_link\"]/img") WebElement item;
	@FindBy(id="add-to-cart-sauce-labs-fleece-jacket") WebElement addtocart;
	
	public void product4checkout() {
