...
public class Product5 { 
	...
	public Product5(WebDriver driver) { 
		this.driver = driver;  
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//*[@id=\"item_2_img_link\"]/img") WebElement item;
	@FindBy(id="add-to-cart-sauce-labs-onesie") WebElement addtocart;
	
	public void product5checkout() {
