...
public class Product6 { 
	...
	public Product6(WebDriver driver) { 
		this.driver = driver;  
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//*[@id=\"item_3_img_link\"]/img") WebElement item;
	@FindBy(id="add-to-cart-test.allthethings()-t-shirt-(red)") WebElement addtocart;
	
	public void product6checkout() {
